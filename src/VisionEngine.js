...
export class VisionEngine {
    ...
    async initialize() {
        ...
        try {
            try {
                // SAFARI FIX V3: Polite Denial (getContext Hijacking)
                // Setting global WebGLRenderingContext to undefined caused "instanceof" errors.
                // Instead, we hijack HTMLCanvasElement.getContext to return null for WebGL.
                // This politely tells MediaPipe that WebGL is not supported, without breaking globals.
                let originalGetContext = null;

                if (this.isSafari) {
                    console.log('VisionEngine: Applying Safari getContext Hijacking...');
                ...
                try {
                    ...
                    if (this.isSafari && originalGetContext) {
                        ...
                        console.log('VisionEngine: Safari getContext Hijack Restored.');
                    }
                }
